...
contract ReserveContract {
    ...
    constructor(address investor, uint _tokenBalance,address _parent ) {
            owner = investor;
    ...
    function cancelInvestment(address) public {
    ...
    function stakeInvestment(address, IERC20 MindPayToken) public {
